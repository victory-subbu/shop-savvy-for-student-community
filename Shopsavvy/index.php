...
<style>
    .jumbotron {  padding-top: 30px;  padding-bottom: 30px;  margin-bottom: 30px;  color: inherit;  background-color: orange;}
    </style>
<script>
...
<div class="btn-group btn-group-justified col-sm-12 m-2">
    <a href="index.php?pricedp" class="btn btnselect ">Filter by Lowest price</a>
    <a href="index.php?pricepd" class="btn btnselect ">Filter by Highest price</a>
    <a href="index.php?New" class="btn btnselect ">Recently added items</a>
  </div>
</div>
<section class="ads">
    <div class="container">
        <div class="jumbotron h-3" >
        <p class="text-center"><h1 class="text-center">Explore<h1></p>    
        </div>
        <div class="row ">
        <?php 
